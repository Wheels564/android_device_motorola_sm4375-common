...
COMMON_PATH := device/motorola/sm4375-common
...
BOARD_PREBUILT_DTBIMAGE_DIR := $(COMMON_PATH)/prebuilts
TARGET_PREBUILT_DTB := $(COMMON_PATH)/prebuilts/dtb.img
BOARD_MKBOOTIMG_ARGS += --dtb $(TARGET_PREBUILT_DTB)dtb.img
BOARD_INCLUDE_DTB_IN_BOOTIMG := true
